...
export function Contact() {
  ...
  const contactFormEnabled = Boolean(profile.contactFormEndpoint);
  ...
  return (
    <section className="section contact" id="contact" aria-labelledby="contact-title">
      <div className="shell contact__inner">
        ...
        {contactFormEnabled && <form className="contact-form" action={profile.contactFormEndpoint} method="POST" onSubmit={submitForm} data-motion-item>
          <label htmlFor="chibi-name">Name<input id="chibi-name" name="name" type="text" autoComplete="name" required /></label>
          <label htmlFor="chibi-email">Email<input id="chibi-email" name="email" type="email" autoComplete="email" spellCheck={false} required /></label>
          <label htmlFor="chibi-message">Message<textarea id="chibi-message" name="message" required /></label>
        ...
        {(profile.email || profile.links.linkedin || profile.links.github) && <div className="contact__links" data-motion-item>{profile.email && <a className="text-link" href={`mailto:${profile.email}`}>Email</a>}{profile.links.linkedin && <a className="text-link" href={profile.links.linkedin} target="_blank" rel="noreferrer">LinkedIn</a>}{profile.links.github && <a className="text-link" href={profile.links.github} target="_blank" rel="noreferrer">GitHub</a>}</div>}
        {profile.location && <p className="contact__location" data-motion-item>Based in {profile.location}</p>}
      </div>
    </section>
  );
}
