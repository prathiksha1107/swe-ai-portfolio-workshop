      ...
      <div className="hero__layout shell">
        <div className="hero__content">
          ...
          <div className="button-row" data-motion-item>
            ...
            {profile.links.github && <a className="text-link" href={profile.links.github} target="_blank" rel="noreferrer">GitHub</a>}
            {profile.links.linkedin && <a className="text-link" href={profile.links.linkedin} target="_blank" rel="noreferrer">LinkedIn</a>}
          </div>
        </div>
