    ...
    <section className="hero section" id="hero" aria-labelledby="hero-title">
      ...
      <div className="hero__layout shell">
        <div className="hero__content">
          <p className="hero__chapter" data-motion-item>Departure 01 · From shore to systems</p>
          ...
          <div className="hero__coordinates" data-motion-item><span aria-hidden="true">⌖</span><strong>{profile.location}</strong><small>Scroll to set sail</small></div>
        </div>
