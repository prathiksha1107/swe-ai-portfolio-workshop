          ...
          {profile.projects.map((project, index) => (
            <article className="project-card" data-project-card key={project.title}>
              ...
              <div className="project-card__body">
                ...
                {(project.githubUrl || project.demoUrl) && <div className="project-card__links" data-project-detail>{project.githubUrl && <a href={project.githubUrl}>GitHub</a>}{project.demoUrl && <a href={project.demoUrl}>Live demo</a>}</div>}
              </div>
            </article>
          ))}
        </div>
